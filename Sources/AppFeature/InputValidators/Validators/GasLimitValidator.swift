...
public struct GasLimitValidator: InputValidator {
    public typealias Error = AmountError<Qa>

    /// Parses `limitString`; rejects non-numeric input and values below `GasLimit.minimum`.
    public func validate(input limitString: String) -> Validation<GasLimit, Error> {
