...
/// Test-only `InputError` whose `errorMessage` echoes the constructor input,
/// so equality assertions can compare two distinct instances by content.
struct StubError: InputError, Equatable {
    let message: String
